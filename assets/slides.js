...
'</div>'+
'<div class="grid g2" style="margin-top:12px">'+
'<div><img class="shot" src="assets/circle-classroom.jpg" alt="辰光國小班級圍圈實景（學生臉部已打碼）"><p class="cap">班級圍圈：心得分享時間</p></div>'+
'<div><img class="shot" src="assets/circle-library.jpg" alt="辰光國小全校圍圈實景（學生臉部已打碼）"><p class="cap">全校圍圈：情緒卡引導</p></div>'+
'</div>'},
...
'<div class="rule"></div>'+
'<div class="eyebrow">課後複習 · 有手機的人現在就可以掃碼試試看</div>'+
'<div class="qrpage">'+
'<div class="qrbox" data-qr="https://cyysongyy.github.io/5signals-at-CG/"><div class="qrimg"></div><div class="u"></div><a class="go" href="#" target="_blank">開始測驗</a></div>'+
'<div class="card"><h4 style="margin-bottom:.4em">5 Signals 手勢小測驗</h4>'+
'<p style="color:var(--ink2);font-size:.95em;margin:0 0 .6em">看情境描述，選出對應的手勢。玩完剛好也順便記住了這五個手勢。</p>'+
'<p style="color:var(--muted);font-size:.86em;margin:0">cyysongyy.github.io/5signals-at-CG</p></div>'+
'</div>'},
...
'</div>'+
'<div class="note blue" style="margin-top:.6em"><b>115 學年度更新：</b>課後 Check-out 現在固定以<b>七大品格</b>收尾 —— 學生從當週學到的品格中選一個，說一句「我今天做到的品格是＿＿＿，因為＿＿＿」，讓球拍／花朵的情緒指標，最後收斂成具體的品格語言。</div>'+
...
'<h2 class="h-slide">40 分鐘裡投資報酬率最高的那一分鐘</h2>'+
...
'</div></div>'+
'<div class="card" style="margin-top:12px;background:linear-gradient(160deg,#fff,#f4f9f6)">'+
'<h4 style="margin-bottom:.6em">圍圈現場・真實省思紀錄（114 學年度）</h4>'+
'<div class="grid g3" style="gap:10px">'+
'<div style="background:#fff;border-radius:12px;padding:.7em .8em;box-shadow:var(--sh);border-top:4px solid var(--dawn)"><div class="tag" style="margin-bottom:.3em">❤️ 堅毅週</div><p style="font-size:.85em;color:var(--ink2);margin:0">「疊杯活動雖只一次，但每組皆成功安靜完成。學生願意自我覺察，舉出今天的表現。」</p></div>'+
'<div style="background:#fff;border-radius:12px;padding:.7em .8em;box-shadow:var(--sh);border-top:4px solid var(--relate)"><div class="tag" style="margin-bottom:.3em">💙 感恩週</div><p style="font-size:.85em;color:var(--ink2);margin:0">「孩子理解感恩不只是說『謝謝』，更包含關心、體貼與珍惜他人的付出。」</p></div>'+
'<div style="background:#fff;border-radius:12px;padding:.7em .8em;box-shadow:var(--sh);border-top:4px solid var(--energy)"><div class="tag" style="margin-bottom:.3em">💛 熱情週</div><p style="font-size:.85em;color:var(--ink2);margin:0">「用『味道』比喻自己的熱情，連平時較少發言的孩子，也降低了表達壓力、願意參與分享。」</p></div>'+
'</div>'+
'<p style="font-size:.82em;color:var(--muted);margin:.7em 0 0">— 摘自辰光國小教師週四圍圈省思紀錄（已去識別化，不含學生／教師姓名與照片）</p>'+
'</div>'},
